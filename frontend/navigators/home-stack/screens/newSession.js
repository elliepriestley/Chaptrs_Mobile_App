...
import ChooseBookModal from '../../../components/modals/ChooseBookModal';
import SelectedBook from '../../../components/cards/SelectedBook';
...
export default function NewSessionScreen({ navigation: { navigate } }) {
  const { myBookclubs, setSessions } = useMainContext();
